 ...
 * @author nanohp
 */
public class VistaGPerfilUsuario extends javax.swing.JInternalFrame implements GestionarModelo, GestorEventos {
    ...
    public VistaGPerfilUsuario(Controlador controlador) {
        initComponents();
    ...
    private void jBAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAceptarActionPerformed
        ...
        usuario.setApellido1(this.jTextFieldApellido1.getText());
        usuario.setApellido2(this.jTextFieldApellido2.getText());
        usuario.setDireccion(this.jTextFieldDireccion.getText());
        usuario.setClave(this.jTextFieldClave.getText());
        usuario.setEmail(this.jTextFieldEmail.getText());
        usuario.setTelefono(Integer.parseInt(jTextFieldTelefono.getText()));
    ...
    public void procesarEvento(Evento evento) {
        switch (evento.getTipoEvento()) {
            case ALTA_USUARIO_OK:
                setVisible(false);
                JOptionPane.showMessageDialog(this,
                        "Alta usuario correcto",
                        "Alta usuario correcto",
                        JOptionPane.DEFAULT_OPTION);
                break;

            case ALTA_USUARIO_ERROR:
                setVisible(false);
                JOptionPane.showMessageDialog(this,
